...
- **Featured (⭐ แนะนำ):** manual selection via `featured:true` field ใน court data (เดิม auto-compute จาก rating+reviews แต่เปลี่ยนเป็น manual 2026-05-18) ผ่าน `isFeatured(court)`; populates the Featured carousel + lime accent บน map markers. ปัจจุบัน 11 courts: tennis 1,6,7,21,24,28,40 + pickleball 101,102,106,112
...
### Tennis (TENNIS_COURTS — ids 1–67 ยกเว้น 3, 4, 5, 10, 25, 44, 50, 51, 59, total 58 courts)
```js
{
