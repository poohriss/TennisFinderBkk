...
- **สนาม Pickleball:** 38 สนาม — original 20 (ids 101–120) + 18 ใหม่จาก Google Places (ids 121+ ยกเว้น 126 deleted); 3 สนามใน original ยังต้องตรวจสอบ (110, 118, 119); **id:126 รับสอน Pickleball หลักสูตรมาตรฐานสากล deleted (2026-05-23)** — coaching service ไม่ใช่คอร์ตจริง (ไม่มี rating/reviews/photos)
