...
- [ ] Verify aircon สนามที่ยังไม่แน่ใจ (Club 46, Suk Space, Windfield Tennis, CV Sport) — Beat Discovery resolved: ventilated/high roof, ไม่ใช่แอร์ (aircon:false). Arise removed from list (id:110 deleted — Lumpini Tower เป็น office)
