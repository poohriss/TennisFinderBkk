...
- [ ] **เติมรูปใหม่ 16 สนามที่รูปหมดอายุ** (หลัง prune 2026-06-11) — ส่งลิงก์รูปจากหน้า Google Maps (`/p/` หรือ `gps-cs-s`) มาตาม workflow เพิ่มรูป; **tennis เหลือสนามเดียว: id:6 Peninsula** (ใช้ลิงก์ peninsula.com ไม่ได้ — hotlink protection 403 — ต้องใช้รูปจาก Google Maps แทน, เช่นเดียวกับ id:109 Peninsula pickleball) + pickleball 15 สนาม: ids 101, 103, 106, 109, 115, 116, 117, 122, 123, 127, 130, 132, 133, 137, 138; ✅ **tennis เติมครบแล้ว 30 สนาม** (2026-06-11, gps-cs-s จาก user, 3 รอบ): ids 2, 7, 8, 11, 13, 15, 17, 18, 19, 20, 21, 23, 24, 29, 31, 32, 38, 39, 40, 43, 46, 47, 49 (พร้อม googleMaps link ใหม่ + GPS ขยับไปพินคอร์ตเทนนิสในสวน 13.814473/100.556988), 53, 55, 57, 60, 62, 64, 65 — **หมายเหตุ:** id:106 Sterling (pickleball) เป็น venue เดียวกับ id:31 ถ้าอยากใช้รูปร่วมกันก็ได้
